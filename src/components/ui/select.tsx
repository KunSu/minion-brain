...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      position={position}
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-app border bg-surface shadow-lg",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-accent-soft focus:text-foreground focus:outline-none data-[state=checked]:font-medium",
      className,
    )}
    {...props}
  >
